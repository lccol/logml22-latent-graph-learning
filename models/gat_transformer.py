...
from .transformer_model import TransformerEnc
...
class GATConvTransformer(MessagePassing):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        if isinstance(in_channels, int):
            self.lin_src = TransformerEnc(in_channels, heads * out_channels,
                                  bias=False, weight_initializer='glorot')
            self.lin_dst = self.lin_src
        else:
            self.lin_src = TransformerEnc(in_channels[0], heads * out_channels, False,
                                  weight_initializer='glorot')
            self.lin_dst = TransformerEnc(in_channels[1], heads * out_channels, False,
                                  weight_initializer='glorot')
...
class GATConvLSTM(MessagePassing):
    def __init__(
        self,
        in_channels: Union[int, Tuple[int, int]],
        out_channels: int,
